  ...
  <div>
    ...
    <div class="container">
            ...
            <div class="card-body">
              <form @submit.prevent="addFunds">
                <div class="form-group">
                  <label class="d-block">Select amount of tokens to be added:</label>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mt-5">
            <div class="card-header"><strong>Transfer tokens</strong></div>
            <div class="card-body">
              <form @submit.prevent="transfer">
                ...
                <div class="form-group">
                  ...
                  <input v-model="receiver" type="text" class="form-control" placeholder="Enter Telco_Id (Public key)" required>
                </div>
                <div class="form-group">
                  <label>Amount:</label>
